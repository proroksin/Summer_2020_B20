...
public class ListInterface {
    ...
    public static void main(String[] args) {
        ...
        List<Integer>  list1 = new ArrayList<>(); // get, add, contains, remove, set, removeAll, size
        ...
        List<Integer> list2 = new LinkedList<>(); // get, add, contains, remove, set, removeAll, size
        ...
        List<Integer> list3 = new Vector<>();  // get, add, contains, remove, set, removeAll, size
        ...
        List<Integer> list4 = new Stack<>(); // get, add, contains, remove, set, removeAll, size
        ...
        groups.addAll(Arrays.asList(new Stack<>(), new Stack<>(), new Stack<>(), new Stack<>(), new Stack<>()));

        groups.get(0).addAll(Arrays.asList("Alexey","Ana","Andrei","Busra","Oleg"));
