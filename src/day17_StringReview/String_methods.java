...
public class String_methods {
    /*
    String methods: charAt, +, length, upper, lower, trim, substring, replace, replaceFirst,
    indexOf, lastIndexOf, equals, equalsIgnorecase, isEmpty, ends, starts,contains
     */
    public static void main(String[] args) {
        ...
        char ch2 = str3.charAt(l-1); // str3.length()-1 ==? 8 - 1 ==>7
        ...
        // indexOf & lastIndexOf ==> int (index cannot be decimal)
