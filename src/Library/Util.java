...
public class Util {
    ...
    // combines to Arrays and returns it
    ...
    // inserts the elemnt in the array
    ...
    public static double[] sortDesc(double[] arr) {
        ...
        double[] arr2 = new double[5]; // {5,4,3,2,1};
    ...
    public static Integer[] sortDesc(Integer[] arr){
        ...
        Integer[]arr2 = new Integer[5]; // {5,4,3,2,1};
    ...
    public static Character[] sortDesc(Character[] arr){
        ...
        Character[]arr2 = new Character[5]; // {5,4,3,2,1};
    ...
    // combine to arrays and returns it
    ...
    /*
    1. method that can find a frequency of characters
    2. method that can find a unique characters from the string
    3. method that can combine two int arrays
     */
