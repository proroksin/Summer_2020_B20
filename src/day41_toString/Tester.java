...
class TesterObject {
    public static void main(String[] args) {
        ...
        testers[1].setInfo("Naz", 150000, "Female", 29);
        testers[2].setInfo("Kalbinur", 155000, "Female", 27);
        testers[3].setInfo("Rakhat", 130000, "Female", 30);
        testers[4].setInfo("Edward", 110000, "Male", 36);
